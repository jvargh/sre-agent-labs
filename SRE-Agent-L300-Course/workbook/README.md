...
> **Reference:** [SREA-Level300.md §M10](../../SREA-Level300.md#m10--audit-finops--observability)
...
Each query maps to a specific M10 learning outcome:

| # | Query | M10 Outcome | What It Shows |
|---|-------|-------------|---------------|
...
| 5 | **Approval rate per approver** | Approval bottlenecks | `ApprovalDecision` approve vs reject percentage per approver. Identifies approvers who are bottlenecks or rubber-stamping. Supports the M1 recommendation of ≥2 approvers on rotation. |
...
The workbook queries against these `customEvents` event types (per M10):
