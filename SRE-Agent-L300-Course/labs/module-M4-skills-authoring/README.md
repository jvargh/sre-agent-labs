...
Discuss how custom agents (M6) use `allowed_skills` to restrict which skills they can load:
```yaml
...
- [ ] Ready for M5 (Kusto tools) and M6 (custom agents referencing skills).
