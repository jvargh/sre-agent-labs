...
| Attendee wants to skip to Autonomous for all triggers | Over-confidence from L200 | Walk through the matrix: show that even P1 response plans need Hooks (M9) before Autonomous is safe |
