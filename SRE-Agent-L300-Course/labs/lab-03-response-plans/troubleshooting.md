...
|---------|-------------|------------|
| Autonomous mode greyed out on `p1-investigator` | Agent resource not set to Privileged permissions | Update agent permissions per Lab 1 matrix; see [Manage Permissions](https://sre.azure.com/docs/tutorials/agent-config/manage-permissions) |
...
| Double-routing (incident processed twice) | Quickstart plan still exists from L200 | Delete the quickstart plan in Builder → Incident Response Plans (should have been done in Lab 2) |
