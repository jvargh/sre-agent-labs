...
# M11 — Enterprise Topology: VNET-Isolated Observability, Cross-Tenant Connectors, Agent Identity Sidecar
...
> **Prerequisites:** Second sandbox subscription (prereq #2) + named Entra admin (prereq #8) reachable during this module.
...
| Time | Checkpoint |
|------|-----------|
| 0:00 | Lab start — verify M10 workbook saved |
...
Proceed to [M12 — Configuration as Code](../module-M12-config-as-code/README.md).
