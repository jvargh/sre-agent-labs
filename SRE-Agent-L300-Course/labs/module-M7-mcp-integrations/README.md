...
# M7 — MCP Integrations II: Partner Connectors, Wildcards, 80-Tool Budget, Plugin Marketplace
...
| Time | Checkpoint |
|------|-----------|
| 0:00 | Lab start — verify sandbox + M6 chain functional |
...
- **Action:** Open a custom agent (e.g., `db-expert` from M6) → **Tools** tab → use the portal tool picker to add individual MCP tools.
...
Proceed to [M8 — Python Tools](../module-M8-python-tools/README.md).
