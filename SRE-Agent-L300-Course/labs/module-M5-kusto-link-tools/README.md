...
# M5 — Custom Tools I: Kusto + Link Tools

> **Format:** Lab (60 min).
> **Outcome:** One reusable, parameterized Kusto tool callable by the `p1-investigator` from M3.
...
- [ ] Ready for M6 (custom agents in YAML referencing this tool).
