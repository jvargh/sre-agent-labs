# M10 — Audit, FinOps & Observability: Troubleshooting
...
- **Fix:** Wait 2–3 minutes after running an agent action. Verify the agent resource has App Insights linked. Re-fire a test incident from M3.
...
- **Fix:** Expected if M3 plans are Autonomous. Note in the workbook as "N/A." To generate data, temporarily set one plan to Review mode and process an incident.
