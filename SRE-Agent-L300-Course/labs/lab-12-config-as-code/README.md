...
duration_minutes: 90
track: all
dependencies: [Lab 1, Lab 2, Lab 3, Lab 4, Lab 5, Lab 6, Lab 7, Lab 8, Lab 9, Lab 10, Lab 11]
source_md_sha: 37BDC62AD9BD827BE88ADFA55CFF3263C8EA120E6C4329BAA87C2968FA7DD102
---

# Lab 12 — Configuration as Code: Bicep/ARM, YAML + REST API v2, Knowledge Persistence, Drift Control

## Learning Outcome

The attendee's Lab 1 promotion-playbook decisions land as a PR: IaC for the agent (Bicep or Terraform), custom agents + hooks via REST API v2, knowledge persistence deep dive, and drift-detection query.
...
| Time | Checkpoint |
|------|-----------|
| 0:00 | Lab start — verify Lab 11 topology diagram |
...
| Role Assignments | Per the Lab 1 promotion-playbook matrix |
...
- **Action:** Export the portal-built custom agents and hooks as YAML:
  ...
  ```
- **Expected state:** YAML file with agent configuration including hooks from Lab 9.
...
- **Action:** In App Insights (from Lab 10), author a new KQL query:
...
- **Action:** Save this query as `agent-config-drift` in the Lab 10 workbook.
- **Expected state:** Six queries total in the workbook (five from Lab 10 + this drift query).
...
- **Action:** Open a PR with title: `[Lab 12] Agent-as-code: <attendee-name>`.
...
> **🔖 Checkpoint CP5** — PR landed. All Lab 12 artifacts committed.

---

## Next Lab

Proceed to [Lab 13 — Capstone](../../) (trainer-led).
