...
duration_minutes: 90
track: all
dependencies: [Lab 1, Lab 2, Lab 3, Lab 4, Lab 5, Lab 6, Lab 7]
source_md_sha: 37BDC62AD9BD827BE88ADFA55CFF3263C8EA120E6C4329BAA87C2968FA7DD102
---

# Lab 8 — Custom Tools II: Python Tools (AI-Generated, BYO, HTTP-Wrap) + Managed-Identity Scopes
...
| Time | Checkpoint |
|------|-----------|
| 0:00 | Lab start — verify Lab 7 connectors functional |
...
| 0:75 | ✅ CP5 — Tool 3 wired to db-expert from Lab 6 |
...
- **Action:** Open `db-expert` from Lab 6 → **Tools** tab → add `cmdb-lookup`.
- **Expected state:** The tool appears in db-expert's tool list alongside the Kusto tool from Lab 5.
...
Proceed to [Lab 9 — Agent Hooks](../lab-09-agent-hooks/README.md).
