...
pres.title = "Enterprise Topology";
...
(() => {
  ...
  // Out of scope
  s.addText("Out of Scope for This Lab", {
    x: 0.8, y: 3.4, w: 8.4, h: 0.4,
    fontSize: 16, fontFace: HEADER_FONT, color: "E53935", bold: true,
  });

  const oos = [
    "Lab 12 Config-as-Code — agent IaC PR workflow (separate lab)",
    "Lab 13 Capstone drill — production rollout playbook",
    "Custom MCP server development (covered in Lab 5/Lab 8)",
...
const outPath = path.join(__dirname, "lab-11-enterprise-topology.pptx");
