...
pres.title = "Module 1: Promotion Playbook";
...
(() => {
  ...
  const boxes = [
    ...
    { label: "Autonomous\nw/ Hooks", sub: "M9 hooks required", color: "FF9800", x: 4.9 },
  ...
  s.addText([
    ...
    { text: "Each step right requires explicit justification. Never skip steps. Hooks (M9) are the safety net that makes Autonomous viable for write operations.", options: { fontSize: 14, fontFace: BODY_FONT, color: "444444" } },
...
(() => {
  ...
  const items = [
    { module: "M9", title: "Agent Hooks", desc: "Stop hooks, PostToolUse hooks — the safety net for Autonomous mode" },
    { module: "M10", title: "Audit & Observability", desc: "IncidentActivitySnapshot workbook, token-spend tracking" },
    { module: "M11", title: "Enterprise Topology", desc: "VNET isolation, cross-tenant connectors, Agent Identity sidecar" },
    { module: "M12", title: "Config-as-Code", desc: "Agent IaC PR workflow, YAML-defined custom agents in source control" },
  ];
...
const outPath = path.join(__dirname, "M1-promotion-playbook.pptx");
